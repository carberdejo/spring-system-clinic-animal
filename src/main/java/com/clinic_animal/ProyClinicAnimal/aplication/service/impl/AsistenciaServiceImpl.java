...
public class AsistenciaServiceImpl implements AsistenciaService {
    ...
    @Override
    public List<AsistenciaResponseDto> listarByEstado(AsistenciaEstadoRequestDto estado) {
        return List.of();
        //TODO: Completar
    }
    ...
    public AsistenciaResponseDto registrarSalida(Long id) {
        ...
        Asistencia asistencia = asistenciaRepository.findByFechaAndPersonalId(LocalDate.now(),personal.getId());
        if(asistencia == null){
            throw new ErrorNegocio("Para registrar la salida primero tienes que registrar la entrada");
        }
